...
const Home: NextPage = () => {
  return (
    <Fragment>
      ...
      >
        <Image src={HeroImage} alt="hero image" className="relative" />
        <div className="absolute bg-mesh-gradient bg-cover w-full h-full top-0 left-0 bg-blend-screen"></div>
        <div className="absolute bg-mesh-gradient bg-cover w-full h-full top-0 left-0 bg-blend-mulitply"></div>
