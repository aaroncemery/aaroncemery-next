...
const Home: NextPage = () => {
  return (
    <Fragment>
      ...
      <div
        className={`container aspect-video relative bg-hero-pattern rounded-xl m-auto bg-cover`}
      >
        ...
        <div className="absolute bg-mesh-gradient bg-cover w-full h-full top-0 left-0 mix-blend-multiply"></div>
